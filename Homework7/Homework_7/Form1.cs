...
namespace Homework_7
{
    ...
    public partial class Form1 : Form
    {
        ...
        List<List<Point>> trajectorylist;
        ...
        private void drawHorizontalChart(Bitmap b, Graphics g, PictureBox pictureBox, Dictionary<int, int> distr, int numElement)
        {
            ...
            foreach (var item in distr)
            {
                ...
                g.FillRectangle(Brushes.LightBlue, 0, j, (int)virtualX, step);
                g.DrawRectangle(new Pen(Color.Blue), 0, j, (int)virtualX, step);
        ...
        private void drawVerticalChart(Bitmap b, Graphics g, PictureBox pictureBox, Dictionary<int, int> distr, int numElement)
        {
            ...
            foreach (var item in distr)
            {
                ...
                g.FillRectangle(Brushes.MediumPurple, j + 1, pictureBox.Height - (int)virtualX - 1, step, (int)virtualX);
                g.DrawRectangle(new Pen(Color.Purple), j + 1, pictureBox.Height - (int)virtualX - 1, step, (int)virtualX);
